class game{
	...
	eventListener(){
		...
		this.btn_refresh.addEventListener('click', (event)=>{
			document.getElementById('mainScreeen').innerHTML = '';
			document.getElementById('nextScreen').innerHTML ='';
			this.board.rowDestroy = 0
			document.getElementById('txt_score').innerHTML ='';
			this.init();
			this.board.rowDestroy = 0
		});
	...
	init(){
		...
		this.btn_refresh = document.getElementById('btn_refresh');
